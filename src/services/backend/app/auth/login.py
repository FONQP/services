import httpx
from web.backend.models import Users
from sqlmodel import Session, select
from web.backend.db import create_tables, engine
...
def register(user_data: Users):
    with Session(engine) as session:
        ...
        if user:
            raise HTTPException(status_code=400, detail="User Is Already Register")
